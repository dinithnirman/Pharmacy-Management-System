...
import static My_Code.DBconnect.connect;
...
public class Ireport {
    ...
    public static void bill(String b,HashMap parameter) throws SQLException,JRException
    {
        Connection connection = connect();
        
        JasperPrint jp = JasperFillManager.fillReport(b, parameter,connection);
        JRViewer jv = new JRViewer(jp);
