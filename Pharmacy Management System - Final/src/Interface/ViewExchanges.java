 ...
 * @author Devin
 */
public class ViewExchanges extends javax.swing.JFrame {
    Connection ct=null;
    PreparedStatement ps = null;
    ResultSet rs = null;
    
    /**
     * Creates new form ViewExchanges
     */
    public ViewExchanges() {
        initComponents();
    ...
    private void ViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ViewActionPerformed
        ...
        try{
            ...
            String sql = "SELECT I_no,SUM(qty),SUM(total) FROM `pharmng` where date='"+ da +"' GROUP by I_no";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewExchanges.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewExchanges().setVisible(true);
            }
        });
    }
