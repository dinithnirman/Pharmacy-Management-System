...
public class Inventory_Home1 extends javax.swing.JInternalFrame {
...
//            SupplierID = SupID.getSelectedItem ().toString ();
    ...
    private void initComponents() {
        ...
        Manage_ReOrder1 = new javax.swing.JButton();
        ...
        jPanel2.add(Manage_ReOrder, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 180, 40));
        ...
        jPanel2.add(Manage_Expiry, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 180, 40));
        ...
        jPanel2.add(Manage_Sales, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 200, 40));

        Manage_ReOrder1.setBackground(new java.awt.Color(85, 55, 118));
        Manage_ReOrder1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        Manage_ReOrder1.setForeground(new java.awt.Color(255, 255, 255));
        Manage_ReOrder1.setText("Re-Order List");
        Manage_ReOrder1.setAutoscrolls(true);
        Manage_ReOrder1.setBorder(null);
        Manage_ReOrder1.setBorderPainted(false);
        Manage_ReOrder1.setFocusable(false);
        Manage_ReOrder1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Manage_ReOrder1ActionPerformed(evt);
            }
        });
        jPanel2.add(Manage_ReOrder1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 0, 180, 40));
                                            ...
                                            .addGroup(jPanel3Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                                        ...
                                                        .addGap(31, 31, 31)
                                                        .addComponent(Qty, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                                        .addComponent(jLabel9, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                        .addGap(30, 30, 30)
                                                        .addComponent(ICode, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                                        .addGap(25, 25, 25)))
    ...
    private void AddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddActionPerformed
        ...
        try {
            ...
            if ( "Select Item Code".equals ( ItemCode )) {
                ...
                sql = "INSERT INTO sales_stock ( Item_Code, Quantity, Price, Sales_Price, Expiry_Date, Receive_Date,Status,rSt) VALUES ( '"+ ItemCode +"', '"+ Quan +"', '"+ Price +"', '"+ SalesPrice +"', '"+ ExDate +"', '"+ RDate +"','"+  St +"','"+ f +"' )";
                pst = con.prepareStatement ( sql );
                pst.executeUpdate ();
                }
                else{
...
//        SupID.setSelectedItem ( SupplierID );
    ...
    private void Manage_ReOrder1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Manage_ReOrder1ActionPerformed
        // TODO add your handling code here:
        ReOrder_List RL = new ReOrder_List ();
        RL.setVisible ( true );
    }//GEN-LAST:event_Manage_ReOrder1ActionPerformed
    ...
    private javax.swing.JButton Manage_ReOrder1;
